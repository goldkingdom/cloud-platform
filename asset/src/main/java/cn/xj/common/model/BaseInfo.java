...
public class BaseInfo implements Serializable {
    ...
    public BaseInfo(StringBuffer instruction, Class clazz) {
        this.instruction = instruction;
        this.clazz = clazz;
    }

    public BaseInfo(StringBuffer instruction, Map<String, Object> params) {
        this.instruction = instruction;
        this.params = params;
    }

    public BaseInfo(StringBuffer instruction, Map<String, Object> params, Class clazz) {
        this.instruction = instruction;
        this.params = params;
        this.clazz = clazz;
    }
